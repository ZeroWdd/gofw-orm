...
gofw-orm is an ORM framework based on a simple implementation of GO, and is only intended as a beginner's project.[中文](https://github.com/ZeroWdd/gofw-orm/blob/master/README.md)
